...
dataset_dict = {
    ...
    'german': ['data_handler.german', 'GermanDataset_torch'],
...
class DatasetFactory:
    ...
    @staticmethod
    def get_dataset(name, args, split='Train', seed=0, sv_ratio=1, version=1, target_attr='Attractive', add_attr=None, ups_iter=0):
...
class GenericDataset(data.Dataset):
    def __init__(self, args,root, split='train', transform=None, seed=0):
        self.root = root
        self.split = split
